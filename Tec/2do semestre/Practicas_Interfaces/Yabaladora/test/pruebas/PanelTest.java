 ...
 */
public class PanelTest extends javax.swing.JDialog {

    /**
     * Creates new form PanelTest
     */
    public PanelTest(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PanelTest dialog = new PanelTest(new javax.swing.JFrame(), true);
