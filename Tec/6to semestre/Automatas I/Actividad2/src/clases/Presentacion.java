...
public class Presentacion extends JDialog{
    ...
    public Presentacion(){
        ...
        JLabel titulo = new JLabel("Actividad 2");
        titulo.setFont(new Font("Arial",1,20));
        titulo.setAlignmentX(Component.CENTER_ALIGNMENT);
        
        JTextArea descripcion = new JTextArea(4,22);
        descripcion.setText("Programa que abre un archivo de texto y cuenta los caracteres especiales que hay dentro de este.");
