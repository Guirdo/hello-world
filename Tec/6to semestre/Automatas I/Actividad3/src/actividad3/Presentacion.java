...
public class Presentacion extends JDialog{
    ...
    public Presentacion(){
        ...
        JLabel titulo = new JLabel("Actividad 3");
        titulo.setFont(new Font("Arial",1,20));
        titulo.setAlignmentX(Component.CENTER_ALIGNMENT);
        
        JTextArea descripcion = new JTextArea(5,22);
        descripcion.setText("Programa que abre un archivo de texto y cuenta las palabras que sus consonantes estan en orden alfabetico, mostrando el resultado en una tabla y una grafica de barras.");
