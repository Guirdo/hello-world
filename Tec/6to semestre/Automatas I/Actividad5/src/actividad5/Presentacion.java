...
public class Presentacion extends JDialog{
    ...
    public Presentacion(){
        ...
        JLabel titulo = new JLabel("Actividad 5");
        titulo.setFont(new Font("Arial",1,20));
        titulo.setAlignmentX(Component.CENTER_ALIGNMENT);
        
        JTextArea descripcion = new JTextArea(3,22);
        descripcion.setText("Programa que comprueba que una cadena de caracteres es un RFC.");
