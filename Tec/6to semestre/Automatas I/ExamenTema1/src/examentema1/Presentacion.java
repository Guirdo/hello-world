...
public class Presentacion extends JDialog{
    ...
    public Presentacion(){
        ...
        JLabel titulo = new JLabel("Examen Unidad 1");
        titulo.setFont(new Font("Arial",1,20));
        titulo.setAlignmentX(Component.CENTER_ALIGNMENT);
        
        JTextArea descripcion = new JTextArea(5,22);
        descripcion.setText("Programa que cuenta palabras con par de A's, con vocales impares y consonantes multiplos de 3.");
